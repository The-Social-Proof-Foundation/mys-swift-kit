...
public struct RPC_TRANSACTION_FIELDS: MySoKit.SelectionSet, Fragment {
  ...
  public static var __selections: [ApolloAPI.Selection] { [
    ...
    .field("signatures", [MySoKit.Base64Apollo]?.self),
    .field("effects", Effects?.self),
    .include(if: "showInput" || "showRawInput", .field("bcs", alias: "rawTransaction", MySoKit.Base64Apollo?.self))
  ] }
  ...
  public var rawTransaction: MySoKit.Base64Apollo? { __data["rawTransaction"] }
  ...
  public var signatures: [MySoKit.Base64Apollo]? { __data["signatures"] }
  ...
  public struct Effects: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }

    public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.TransactionBlockEffects }
    public static var __selections: [ApolloAPI.Selection] { [
      .field("__typename", String.self),
      .field("checkpoint", Checkpoint?.self),
      .field("timestamp", MySoKit.DateTimeApollo?.self),
      .include(if: "showEffects" || "showObjectChanges" || "showRawEffects", .field("bcs", MySoKit.Base64Apollo.self)),
    ...
    public struct Events: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.EventConnection }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
    ...
    public struct BalanceChanges: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.BalanceChangeConnection }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
        .field("pageInfo", PageInfo.self),
        .field("nodes", [Node].self)
      ...
      public struct Node: MySoKit.SelectionSet {
        ...
        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.BalanceChange }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public var amount: MySoKit.BigIntApollo? { __data["amount"] }
    ...
    public struct ObjectChanges: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.ObjectChangeConnection }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
        .field("pageInfo", PageInfo.self),
        .field("nodes", [Node].self)
      ...
      public struct Node: MySoKit.SelectionSet {
        ...
        ///
        /// Parent Type: `Object`
        public struct InputState: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        ///
        /// Parent Type: `Object`
        public struct OutputState: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }
          ...
          public struct AsMovePackage: MySoKit.SelectionSet {
            ...
            public struct Modules: MySoKit.SelectionSet {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }

              public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.MoveModuleConnection }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
                .field("nodes", [Node].self)
              ] }
