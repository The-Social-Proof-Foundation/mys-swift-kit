...
public struct RPC_VALIDATOR_FIELDS: MySoKit.SelectionSet, Fragment {
  ...
  public static var __selections: [ApolloAPI.Selection] { [
    ...
    .field("atRisk", MySoKit.UInt53Apollo?.self),
    .field("commissionRate", Int?.self),
    .field("exchangeRatesSize", MySoKit.UInt53Apollo?.self),
    .field("exchangeRates", ExchangeRates?.self),
    .field("description", String?.self),
    .field("gasPrice", MySoKit.BigIntApollo?.self),
    .field("imageUrl", String?.self),
    .field("name", String?.self),
    .field("credentials", Credentials?.self),
    .field("nextEpochCommissionRate", Int?.self),
    .field("nextEpochGasPrice", MySoKit.BigIntApollo?.self),
    .field("nextEpochCredentials", NextEpochCredentials?.self),
    .field("nextEpochStake", MySoKit.BigIntApollo?.self),
  ...
  public struct ExchangeRates: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  ///
  /// Parent Type: `ValidatorCredentials`
  public struct NextEpochCredentials: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  ///
  /// Parent Type: `MoveObject`
  public struct OperationCap: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  ///
  /// Parent Type: `MoveObject`
  public struct StakingPool: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
