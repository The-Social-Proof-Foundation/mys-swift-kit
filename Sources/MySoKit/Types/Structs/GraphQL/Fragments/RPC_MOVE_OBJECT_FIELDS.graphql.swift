...
public struct RPC_MOVE_OBJECT_FIELDS: MySoKit.SelectionSet, Fragment {
  ...
  public static var __selections: [ApolloAPI.Selection] { [
    ...
    .include(if: "showStorageRebate", .field("storageRebate", MySoKit.BigIntApollo?.self)),
  ...
  public struct Contents: MySoKit.SelectionSet {
    ...
    ///
    /// Parent Type: `MoveValue`
    public struct IfShowType: MySoKit.InlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct Type_SelectionSet: MySoKit.SelectionSet {
        ...
        public var layout: MySoKit.MoveTypeLayoutApollo? { __data["layout"] }
        /// Structured representation of the type signature.
        public var signature: MySoKit.MoveTypeSignatureApollo { __data["signature"] }
      }
    }
    ...
    ///
    /// Parent Type: `MoveValue`
    public struct IfShowContent: MySoKit.InlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
    ...
    ///
    /// Parent Type: `MoveValue`
    public struct IfShowBcs: MySoKit.InlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  public struct Owner: MySoKit.SelectionSet {
    ...
    public struct AsAddressOwner: MySoKit.InlineFragment, ApolloAPI.CompositeInlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
    ...
    ///
    /// Parent Type: `Parent`
    public struct AsParent: MySoKit.InlineFragment, ApolloAPI.CompositeInlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
    ...
    ///
    /// Parent Type: `Shared`
    public struct AsShared: MySoKit.InlineFragment, ApolloAPI.CompositeInlineFragment {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  public struct PreviousTransactionBlock: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
  ...
  public struct Display: MySoKit.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }

    public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DisplayEntry }
    public static var __selections: [ApolloAPI.Selection] { [
      .field("__typename", String.self),
