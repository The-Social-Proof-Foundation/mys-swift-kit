...
public class ExecuteTransactionBlockMutation: GraphQLMutation {
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.Mutation }
    ...
    public struct ExecuteTransactionBlock: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.ExecutionResult }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Effects: MySoKit.SelectionSet {
        ...
        public struct TransactionBlock: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }
