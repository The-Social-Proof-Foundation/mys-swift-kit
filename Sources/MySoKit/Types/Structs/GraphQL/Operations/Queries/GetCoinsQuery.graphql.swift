...
public class GetCoinsQuery: GraphQLQuery {
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct Address: MySoKit.SelectionSet {
      ...
      public struct Coins: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.CoinConnection }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Node: MySoKit.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.Coin }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public var coinBalance: MySoKit.BigIntApollo? { __data["coinBalance"] }
