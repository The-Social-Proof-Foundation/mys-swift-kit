...
public class DevInspectTransactionBlockQuery: GraphQLQuery {
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct DryRunTransactionBlock: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DryRunResult }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Result: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DryRunEffect }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct MutatedReference: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DryRunMutation }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Input: MySoKit.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public static var __parentType: any ApolloAPI.ParentType { MySoKit.Unions.TransactionArgument }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            ///
            /// Parent Type: `Input`
            public struct AsInput: MySoKit.InlineFragment {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }
              ...
              public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.Input }
              public static var __selections: [ApolloAPI.Selection] { [
            ...
            ///
            /// Parent Type: `Result`
            public struct AsResult: MySoKit.InlineFragment {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }

              public typealias RootEntityType = DevInspectTransactionBlockQuery.Data.DryRunTransactionBlock.Result.MutatedReference.Input
              public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.Result }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("cmd", Int.self),
        ...
        public struct ReturnValue: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DryRunReturn }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("type", Type_SelectionSet.self),
            .field("bcs", MySoKit.Base64Apollo.self)
      ...
      public struct Transaction: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
