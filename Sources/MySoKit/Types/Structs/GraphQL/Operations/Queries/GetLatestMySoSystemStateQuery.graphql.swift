  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct Epoch: MySoKit.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        ...
        .field("startTimestamp", MySoKit.DateTimeApollo.self),
        .field("endTimestamp", MySoKit.DateTimeApollo?.self),
        ...
        .field("systemStateVersion", MySoKit.UInt53Apollo?.self),
      ...
      public var startTimestamp: MySoKit.DateTimeApollo { __data["startTimestamp"] }
      /// The epoch's ending timestamp.
      public var endTimestamp: MySoKit.DateTimeApollo? { __data["endTimestamp"] }
      ...
      public var systemStateVersion: MySoKit.UInt53Apollo? { __data["systemStateVersion"] }
      ...
      public struct SafeMode: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.SafeMode }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct GasSummary: MySoKit.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct SystemStakeSubsidy: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.StakeSubsidy }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("balance", MySoKit.BigIntApollo?.self),
          .field("currentDistributionAmount", MySoKit.BigIntApollo?.self),
        ...
        /// time.
        public var balance: MySoKit.BigIntApollo? { __data["balance"] }
        /// Amount of stake subsidy deducted from the balance per distribution -- decays over time.
        public var currentDistributionAmount: MySoKit.BigIntApollo? { __data["currentDistributionAmount"] }
      ...
      public struct StorageFund: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.StorageFund }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("nonRefundableBalance", MySoKit.BigIntApollo?.self),
          .field("totalObjectStorageRebates", MySoKit.BigIntApollo?.self)
        ] }
        ...
        public var nonRefundableBalance: MySoKit.BigIntApollo? { __data["nonRefundableBalance"] }
        /// Sum of storage rebates of live objects on chain.
        public var totalObjectStorageRebates: MySoKit.BigIntApollo? { __data["totalObjectStorageRebates"] }
      }

      /// Epoch.SystemParameters
      ///
      /// Parent Type: `SystemParameters`
      public struct SystemParameters: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.SystemParameters }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("minValidatorCount", Int?.self),
          .field("maxValidatorCount", Int?.self),
          .field("minValidatorJoiningStake", MySoKit.BigIntApollo?.self),
          .field("durationMs", MySoKit.BigIntApollo?.self),
          .field("validatorLowStakeThreshold", MySoKit.BigIntApollo?.self),
          .field("validatorLowStakeGracePeriod", MySoKit.BigIntApollo?.self),
          .field("validatorVeryLowStakeThreshold", MySoKit.BigIntApollo?.self),
          .field("stakeSubsidyStartEpoch", MySoKit.UInt53Apollo?.self)
        ] }
        ...
        public var minValidatorJoiningStake: MySoKit.BigIntApollo? { __data["minValidatorJoiningStake"] }
        /// Target duration of an epoch, in milliseconds.
        public var durationMs: MySoKit.BigIntApollo? { __data["durationMs"] }
        ...
        public var validatorLowStakeThreshold: MySoKit.BigIntApollo? { __data["validatorLowStakeThreshold"] }
        /// The number of epochs that a validator has to recover from having less than
        /// `validatorLowStakeThreshold` stake.
        public var validatorLowStakeGracePeriod: MySoKit.BigIntApollo? { __data["validatorLowStakeGracePeriod"] }
        ...
        public var validatorVeryLowStakeThreshold: MySoKit.BigIntApollo? { __data["validatorVeryLowStakeThreshold"] }
        /// The epoch at which stake subsidies start being paid out.
        public var stakeSubsidyStartEpoch: MySoKit.UInt53Apollo? { __data["stakeSubsidyStartEpoch"] }
      }
      ...
      public struct ValidatorSet: MySoKit.SelectionSet {
        ...
        public static var __selections: [ApolloAPI.Selection] { [
          ...
          .field("totalStake", MySoKit.BigIntApollo?.self),
          .field("stakingPoolMappingsId", MySoKit.MySoAddressApollo?.self),
          .field("pendingActiveValidatorsId", MySoKit.MySoAddressApollo?.self),
          .field("validatorCandidatesId", MySoKit.MySoAddressApollo?.self),
          .field("inactivePoolsId", MySoKit.MySoAddressApollo?.self)
        ] }
        ...
        public var totalStake: MySoKit.BigIntApollo? { __data["totalStake"] }
        ...
        public var stakingPoolMappingsId: MySoKit.MySoAddressApollo? { __data["stakingPoolMappingsId"] }
        /// Object ID of the wrapped object `TableVec` storing the pending active validators.
        public var pendingActiveValidatorsId: MySoKit.MySoAddressApollo? { __data["pendingActiveValidatorsId"] }
        /// Object ID of the `Table` storing the validator candidates.
        public var validatorCandidatesId: MySoKit.MySoAddressApollo? { __data["validatorCandidatesId"] }
        /// Object ID of the `Table` storing the inactive staking pools.
        public var inactivePoolsId: MySoKit.MySoAddressApollo? { __data["inactivePoolsId"] }
        ...
        public struct ActiveValidators: MySoKit.SelectionSet {
          ...
          public struct Node: MySoKit.SelectionSet {
            ...
            /// low stake threshold.
            public var atRisk: MySoKit.UInt53Apollo? { __data["atRisk"] }
            ...
            public var gasPrice: MySoKit.BigIntApollo? { __data["gasPrice"] }
            ...
            public var pendingPoolTokenWithdraw: MySoKit.BigIntApollo? { __data["pendingPoolTokenWithdraw"] }
            ...
            public var rewardsPool: MySoKit.BigIntApollo? { __data["rewardsPool"] }
