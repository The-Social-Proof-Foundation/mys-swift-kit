  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct Epoch: MySoKit.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        ...
        .field("totalTransactions", MySoKit.UInt53Apollo?.self),
      ...
      public var totalTransactions: MySoKit.UInt53Apollo? { __data["totalTransactions"] }
      ...
      public struct FirstCheckpoint: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.CheckpointConnection }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("nodes", [Node].self)
        ] }
