...
public class GetTotalSupplyQuery: GraphQLQuery {
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct CoinMetadata: MySoKit.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.CoinMetadata }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
        .field("supply", MySoKit.BigIntApollo?.self),
        .field("decimals", Int?.self)
      ] }

      /// The overall quantity of tokens that will be issued.
      public var supply: MySoKit.BigIntApollo? { __data["supply"] }
