...
public class GetAllBalancesQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query getAllBalances($owner: MysAddress!, $limit: Int, $cursor: String) { address(address: $owner) { __typename balances(first: $limit, after: $cursor) { __typename pageInfo { __typename hasNextPage endCursor } nodes { __typename coinType { __typename repr } coinObjectCount totalBalance } } } }"#
    ))
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct Address: MySoKit.SelectionSet {
      ...
      public struct Balances: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.BalanceConnection }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
