...
public class GetDynamicFieldsQuery: GraphQLQuery {
  ...
  public struct Data: MySoKit.SelectionSet {
    ...
    public struct Owner: MySoKit.SelectionSet {
      ...
      public struct DynamicFields: MySoKit.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DynamicFieldConnection }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Node: MySoKit.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { MySoKit.Objects.DynamicField }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Name: MySoKit.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }
            ...
            public struct Type_SelectionSet: MySoKit.SelectionSet {
              ...
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
                .field("layout", MySoKit.MoveTypeLayoutApollo?.self),
          ...
          public struct Value: MySoKit.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public static var __parentType: any ApolloAPI.ParentType { MySoKit.Unions.DynamicFieldValue }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            ///
            /// Parent Type: `MoveValue`
            public struct AsMoveValue: MySoKit.InlineFragment {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }
            ...
            public struct AsMoveObject: MySoKit.InlineFragment {
              public let __data: DataDict
              public init(_dataDict: DataDict) { __data = _dataDict }
