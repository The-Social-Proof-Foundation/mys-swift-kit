...
* Add `https://github.com/The-Social-Proof-Foundation/mys-swift-kit.git`
...
```swift
dependencies: [
    .package(url: "https://github.com/The-Social-Proof-Foundation/mys-swift-kit.git", .upToNextMajor(from: "1.3.0"))
]
```

## Using MySoKit

MySoKit is really easy to implement and use in your own projects. Simply provide the provider, transaction block, and account. Here's an example on how to transfer MySo tokens, which also utilizes the key generation functionality of the library
...
You can also read objects from the MySocial blockchain. Below is an example on how to do so.
...
MySoKit is released under the MIT license. As well, MySoKit utilizes some code from the [web3swift package](https://github.com/web3swift-team/web3swift/) that enables functionality for SECP256K1 and BIP32 derivations. That following code is under the [Apache 2.0 license](https://www.apache.org/licenses/LICENSE-2.0.txt). The licenses for both are included in this package under LICENSE.md and COPYING.
